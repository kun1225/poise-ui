...
export function TabIconDemo() {
  return (
    <Tabs defaultValue="overview" className="my-6 max-w-85">
      <TabsList>
        <TabsTrigger value="overview" icon={<GridIcon />}>
          Overview
        </TabsTrigger>
        <TabsTrigger value="analytics" icon={<ChartIcon />}>
          Analytics
        </TabsTrigger>
        <TabsTrigger value="settings" icon={<SlidersIcon />}>
          Settings
        </TabsTrigger>
      </TabsList>
